...
<html lang="en">
  ...
  <body id="staticbody" onload="loadSellerConfirmedOrderResult('<%=userid%>','Cancel')">
  <%
  	String message = "";
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-times-circle-o"></i> Cancelled Orders</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-laptop"></i><a href="<%=contextPah%>/seller/sellerdashboard">Dashboard</a></li>
						<li><i class="fa fa-times-circle-o"></i><a href="<%=contextPah%>/selleractivity/showcancelorder"> Cancelled Orders</a></li>					  	
					</ol>
				</div>
			</div>
...
<%-- 														   </form> --%>
	                                          ...
	                                          <div class="modal-footer">
	                                              <button class="btn btn-success" type="button" data-dismiss="modal" id="seller_cancelOrderSearchByDate">Search</button>
...
<%-- 														   </form> --%>
	                                          ...
	                                          <div class="modal-footer">
	                                              <button class="btn btn-success" type="button" data-dismiss="modal" id="seller_cancelOrderSearchByID">Search</button>
	                                              <button class="btn btn-default" type="reset" >Reset</button>
	                                              <button class="btn btn-default" type="button" data-dismiss="modal">Close</button>
	                                          </div>
                                          </form>
            ...
            <div class="row">
             ...
             <div id="Seller_Order_Deliver_Details">
             </div>
