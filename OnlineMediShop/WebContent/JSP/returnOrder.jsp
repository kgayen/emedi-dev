...
<body id="staticbody" onload="loadRefundOrders('<%=userid%>','Load',null,null,null,null)">
  <%
  	String message = "";
	...
	<section id="container" class="">
	      ...
	      <section id="main-content">
	          <section class="wrapper">            
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="page-header"><i class="fa fa-reply"></i></i>Refund Order</h3>
							<ol class="breadcrumb">
								<li><i class="fa fa-home"></i><a href="<%=contextPah%>/home">Home</a></li>
								<li><i class="fa fa-reply"></i><a href="<%=contextPah%>/order/returnorder">Refund Order</a></li>						  	
							</ol>
						</div>
					</div>
		          	<br>
...
<!-- 		                      <section class="panel"> -->
		                          <header class="panel-heading">
		                              <i class="fa fa-reply"></i><b> Refund Request</b>
		                              <p id="<%=messageTagId%>"></p>
		                              <div>
										  <a class="btn btn-success" data-toggle="modal" href="#initiateReturnRequest">
			                                  Initiate Refund Request
			                              </a>
			                              <a class="btn btn-success" style="display: none;" data-toggle="modal" href="#returnRequest">
			                                  Refund Request
			                              </a>
				                                           ...
				                                           <div class="form">
															      <div class="form-group">
															      		...
															      		<div class="col-lg-10">
									                                          ...
									                                          <label class="checkbox-inline">
									                                              <input type="checkbox" id="inlineCheckbox3" name="refundStatusOption" value="Deliver"> Refunded
									                                          </label>
