...
<html lang="en">
  <head>
    ...
    <title>Online Medicine Shop : Admin Dashboard</title>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li class="eborder-top">
                                <a href="<%=contextPah%>/user/userprofile"><i class="icon_profile"></i> My Profile</a>
                            </li>
                            <li>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="<%=contextPah%>/order/showuserorder">Show User Order</a></li>
                          <li><a class="" href="<%=contextPah%>/order/searchorder">Search Order</a></li>
                          <li><a class="" href="<%=contextPah%>/user/placeorder">Placed Order</a></li>
                          <li><a class="" href="<%=contextPah%>/order/cancelorder">Cancel Order</a></li>
                          <li><a class="" href="<%=contextPah%>/order/returnorder">Refund Order</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      ...
                      <ul class="sub">                          
                          <li><a class="" href="<%=contextPah%>/user/registration">Create Profile</a></li>
                          <li><a class="" href="<%=contextPah%>/user/changepassword"><span>Change Password</span></a></li>
                      </ul>
                  </li>
