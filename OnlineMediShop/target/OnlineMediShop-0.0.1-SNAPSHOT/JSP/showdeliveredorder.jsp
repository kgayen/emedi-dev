...
<html lang="en">
  ...
  <body id="staticbody" onload="loadSellerConfirmedOrderResult('<%=userid%>','Deliver')">
  <%
  	String message = "";
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-check-square-o"></i> Delivered Orders</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-laptop"></i><a href="<%=contextPah%>/seller/sellerdashboard">Dashboard</a></li>
						<li><i class="fa fa-check-square-o"></i><a href="<%=contextPah%>/selleractivity/showdeliveredorder">Delivered Orders</a></li>					  	
					</ol>
				</div>
			</div>
			<div class="row">
