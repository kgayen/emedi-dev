...
<html lang="en">
  ...
  <%
	String contextPah = request.getContextPath();
  	...
  	String display = "none";
  	String userName = "Not A login User";
  	if(user!=null){
  		display = "block";
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <div class="top-nav notification-row">                
                ...
                <ul class="nav pull-right top-menu" style="display:<%=display%>">
...
<%-- 									 <img alt="" src="<c:url value="/user/image/kgayen"/>" > --%>
<!--                             </span> -->
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="<%=contextPah%>/user/logout"><i class="icon_key_alt"></i> Log Out</a>
                            </li>
                            <li>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="<%=contextPah%>/order/newcutomorder">Place Order</a></li>                          
                          <li><a class="" href="<%=contextPah%>/order/vieworder">View Order</a></li>
                      </ul>
                  </li>       
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">                          
                          <li><a class="" href="<%=contextPah%>/retail/newcustomerreg">Registration</a></li>
                          <li><a class="" href="<%=contextPah%>/retail/customerlogin"><span>Customer Login</span></a></li>
                          <li><a class="" href="<%=contextPah%>/retail/customerlogin">View Order Details</a></li>
                      </ul>
                  </li>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<table class="table bootstrap-datatable countries">
								...
								<tbody>
									<tr>
										<td><img src="<c:url value="/resources/img/Germany.png"/>" style="height:18px; margin-top:-2px;"></td>
										<td>Germany</td>
										<td>2563</td>
										<td>1025</td>
										<td>
									...
									<tr>
										<td><img src="<c:url value="/resources/img/India.png"/>" style="height:18px; margin-top:-2px;"></td>
										<td>India</td>
										<td>3652</td>
										<td>2563</td>
										<td>
									...
									<tr>
										<td><img src="<c:url value="/resources/img/Spain.png"/>" style="height:18px; margin-top:-2px;"></td>
										<td>Spain</td>
										<td>562</td>
										<td>452</td>
										<td>
                    ...
                    <ul class="chats">
                      ...
                      <li class="by-me">
                        ...
                        <div class="avatar pull-left">
                          <img src="<c:url value="/resources/img/user.jpg"/>" alt=""/>
                        </div>
                      ...
                      <li class="by-other">
                        ...
                        <div class="avatar pull-right">
                          <img src="<c:url value="/resources/img/user22.png"/>" alt=""/>
                        </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-4">
                                <span class="profile-ava pull-right">
                                        <img alt="" class="simple" src="<c:url value="/resources/img/avatar1_small.jpg"/>">
                                        Jenifer smith
                                </span>                                
                              </div>
                            </div>
